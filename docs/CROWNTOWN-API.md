...
pick-up day. We often start our routes early to beat the heat."* — a company-wide set-out policy,
not a per-account setting. The stops API's `timestamp` field records the actual collection time of
